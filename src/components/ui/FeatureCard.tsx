...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return <div className={`flex w-full flex-col items-start gap-4 border bg-white px-6 py-6 border-solid border-[#B6B6B6] hover:shadow-lg transition-shadow ${className}`}>
      <div className="">
